...
cases = []
testSet = {}
exclude_list = ["securitygroup.rego", "tags.rego"]
    ...
    if file.endswith(".rego") and file not in exclude_list:
        ...
        with open(file_name, "r") as rego_file:
            ...
            for key, value in file_data_dict.items():
                ...
                for line in value:
                    line = line.strip()
                    if line.startswith("aws_issue"):
                        eval_rule_name = line.split("aws_issue[")[-1][1:-2]
                ...
                rule_count += 1
                master_snapshot_id = ["CFR_TEMPLATE_SNAPSHOT"]
                rule_type = "rego"
                ...
                evals = [{
                    ...
                    "remediationDescription": "Make sure you are following the Cloudformation template format presented at this URL: "+metdata_dict["Resource Help URL"],
...
testSet["masterTestName"] = "AWS_iac_TEST"
testSet["version"] = "0.1"
testSet["cases"] = cases
