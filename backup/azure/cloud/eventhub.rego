...
event_hub_namespace_has_local_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-001",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_hub_namespace_has_double_encryption_enabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-002",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_hub_namespace_configured_with_private_endpoint_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-004",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_hub_namespace_usage_custom_managed_key_for_encryption_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-005",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_hub_namespace_only_has_rootmanage_sharedaccesskey_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-006",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_hub_instance_has_auth_rule_defined_metadata := {
    "Policy Code": "PR-AZR-CLD-EHB-007",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
