...
ct_master_key_err = "CloudTrail attribute kms_key_id missing in the resource" {
    aws_attribute_absence["ct_master_key"]
}
...
ct_cloudwatch_err = "CloudTrail attribute cloud_watch_logs_role_arn missing in the resource" {
    aws_attribute_absence["ct_cloudwatch"]
}
