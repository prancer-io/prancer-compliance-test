...
aws_issue["emr_kerberos"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_cluster"
    not resource.properties.kerberos_attributes.realm
}

aws_issue["emr_kerberos"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_cluster"
    resource.properties.kerberos_attributes.realm == null
}

aws_issue["emr_kerberos"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_cluster"
    count(resource.properties.kerberos_attributes.realm) == 0
}
...
aws_issue["emr_s3_encryption"] {
    ...
    not resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.S3EncryptionConfiguration.EncryptionMode
}

aws_issue["emr_s3_encryption"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    count(resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.S3EncryptionConfiguration.EncryptionMode) == 0
}
...
aws_issue["emr_local_encryption_cmk"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    not resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.LocalDiskEncryptionConfiguration.EncryptionKeyProviderType
}

aws_issue["emr_local_encryption_cmk"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    count(resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.LocalDiskEncryptionConfiguration.EncryptionKeyProviderType) == 0
}
...
aws_issue["emr_rest_encryption"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    lower(resource.properties.configuration.EncryptionConfiguration.EnableAtRestEncryption) == "false"
}

aws_bool_issue["emr_rest_encryption"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    not resource.properties.configuration.EncryptionConfiguration.EnableAtRestEncryption
}
...
aws_issue["emr_s3_encryption_sse"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.S3EncryptionConfiguration.EncryptionMode
    lower(resource.properties.configuration.EncryptionConfiguration.AtRestEncryptionConfiguration.S3EncryptionConfiguration.EncryptionMode) != "sse-kms"
}
...
aws_issue["emr_transit_encryption"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    lower(resource.properties.configuration.EncryptionConfiguration.EnableInTransitEncryption) == "false"
}

aws_bool_issue["emr_transit_encryption"] {
    resource := input.resources[i]
    lower(resource.type) == "aws_emr_security_configuration"
    not resource.properties.configuration.EncryptionConfiguration.EnableInTransitEncryption
}
