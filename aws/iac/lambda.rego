...
lambda_env_err = "Lambda function attribute KmsKeyArn/Environment missing in the resource" {
    aws_attribute_absence["lambda_env"]
}
...
lambda_vpc_err = "Lambda function attribute VpcConfig.SubnetIds missing in the resource" {
    aws_attribute_absence["lambda_vpc"]
}
...
lambda_tracing_err = "Lambda function attribute TracingConfig.Mode missing in the resource" {
    aws_attribute_absence["lambda_tracing"]
}
