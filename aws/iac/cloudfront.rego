...
cf_ssl_protocol_err = "Cloudfront attribute DistributionConfig Origins missing in the resource" {
    aws_attribute_absence["cf_ssl_protocol"]
}
...
cf_logging_err = "Cloudfront attribute DistributionConfig Logging in the resource" {
    aws_attribute_absence["cf_logging"]
}
...
cf_https_only_err = "Cloudfront attribute DistributionConfig Origins missing in the resource" {
    aws_attribute_absence["cf_https_only"]
}
...
cf_https_err = "Cloudfront attribute ViewerProtocolPolicy missing in the resource" {
    aws_attribute_absence["cf_https"]
}
...
cf_min_protocol_err = "Cloudfront attribute MinimumProtocolVersion missing in the resource" {
    aws_attribute_absence["cf_min_protocol"]
}
...
cf_firewall_err = "Cloudfront attribute WebACLId missing in the resource" {
    aws_attribute_absence["cf_firewall"]
}
...
cf_geo_restriction_err = "Cloudfront attribute Geo RestrictionType missing in the resource" {
    aws_attribute_absence["cf_geo_restriction"]
}
...
cf_s3_origin_err = "Cloudfront attribute Origins missing in the resource" {
    aws_attribute_absence["cf_s3_origin"]
}
