...
### Test ID - PR-AWS-0032-RGX
Title: There is a possibility that random password is exposed\
Test Result: **passed**\
Description : There is a possibility that random password is exposed, template should not have any secret in it. Make sure to put the secrets in a vault\
