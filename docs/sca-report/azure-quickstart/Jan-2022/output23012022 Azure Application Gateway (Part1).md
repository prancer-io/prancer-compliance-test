...
## Azure Application Gateway (Part1) Services
...
Test Result: **failed**\
Description : Application Gateway allows seting network protocols Http and Https. It is highly recommended to use Https protocol for secure connections.\
...
- masterTestId: PR-AZR-ARM-AGW-003
- masterSnapshotId: ['ARM_TEMPLATE_SNAPSHOT']
- type: rego
- rule: file(https://github.com/prancer-io/prancer-compliance-test/tree/master/azure/iac/applicationgateways.rego)
- severity: Medium
