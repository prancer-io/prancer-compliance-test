...
|Title|Description|
| :---: | :---: |
|id|PR-GCP-CLD-FW-010|
|eval|data.rule.firewall_port_110|
|message|data.rule.firewall_port_110_err|
...
|remediationFunction|PR_GCP_CLD_FW_010.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Description:</font>*** This policy identifies GCP Firewall rules which allows inbound traffic on POP3 port (110) from public internet. Allowing access from arbitrary internet IP addresses to this port increases the attack surface of your network.  
