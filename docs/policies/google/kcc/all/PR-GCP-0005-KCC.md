...
|message|data.rule.open_ciscosecure_websm_port_err|
...
***<font color="white">Description:</font>*** A firewall is configured to have an open CISCOSECURE_WEBSM port that allows generic access.  
