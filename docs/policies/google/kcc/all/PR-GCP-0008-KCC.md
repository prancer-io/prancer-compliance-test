...
|message|data.rule.open_elasticsearch_port_err|
...
***<font color="white">Description:</font>*** A firewall is configured to have an open ELASTICSEARCH port that allows generic access.  
