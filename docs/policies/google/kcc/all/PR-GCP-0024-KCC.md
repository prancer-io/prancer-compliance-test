...
|message|data.rule.open_telnet_port_err|
...
***<font color="white">Description:</font>*** A firewall is configured to have an open TELNET port that allows generic access.  
