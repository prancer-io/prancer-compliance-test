...
|message|data.rule.open_mongodb_port_err|
...
***<font color="white">Description:</font>*** A firewall is configured to have an open MONGODB port that allows generic access.  
