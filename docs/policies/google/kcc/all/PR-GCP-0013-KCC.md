...
|message|data.rule.open_memcached_port_err|
...
***<font color="white">Description:</font>*** A firewall is configured to have an open MEMCACHED port that allows generic access.  
