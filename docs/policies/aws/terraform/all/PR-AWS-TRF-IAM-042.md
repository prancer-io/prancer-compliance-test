...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-TRF-IAM-042|
|eval|data.rule.iam_policy_attached_to_user|
|message|data.rule.iam_policy_attached_to_user_err|
|remediationDescription|Make sure you are following the Cloudformation template format presented <a href='https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_user_policy_attachment' target='_blank'>here</a>|
|remediationFunction|PR_AWS_TRF_IAM_042.py|
...
***<font color="white">Resource Types:</font>*** ['aws_iam_user_policy', 'aws_iam_user_policy_attachment']
