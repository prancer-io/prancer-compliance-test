...
|remediationDescription|Make sure you are following the Terraform template format presented <a href='https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet' target='_blank'>here</a>|
|remediationFunction|PR_AWS_TRF_VPC_001.py|
...
***<font color="white">Resource Types:</font>*** ['aws_subnet']
