...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-TRF-S3-008V4|
|eval|data.rule.s3_public_acl_v4|
|message|data.rule.s3_public_acl_v4_err|
...
|remediationFunction|PR_AWS_TRF_S3_008V4.py|
...
***<font color="white">Resource Types:</font>*** ['aws_s3_bucket_acl']
