...
|remediationDescription|Make sure you are following the Terraform template format presented <a href='https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method' target='_blank'>here</a> |
|remediationFunction|PR_AWS_TRF_AG_006.py|
...
***<font color="white">Resource Types:</font>*** ['aws_api_gateway_method']
