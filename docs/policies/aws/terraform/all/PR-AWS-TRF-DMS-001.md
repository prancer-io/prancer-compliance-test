...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-TRF-DMS-001|
|eval|data.rule.dms_endpoint|
|message|data.rule.dms_endpoint_err|
|remediationDescription|Make sure you are following the Terraform template format presented <a href='https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/dms_endpoint' target='_blank'>here</a>|
|remediationFunction|PR_AWS_TRF_DMS_001.py|
...
***<font color="white">Resource Types:</font>*** ['aws_dms_endpoint']
