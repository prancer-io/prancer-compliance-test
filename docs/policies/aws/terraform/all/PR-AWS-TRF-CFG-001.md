...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-TRF-CFG-001|
|eval|data.rule.config_all_resource|
|message|data.rule.config_all_resource_err|
|remediationDescription|Make sure you are following the Terraform template format presented <a href='https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/config_configuration_recorder' target='_blank'>here</a>|
|remediationFunction|PR_AWS_TRF_CFG_001.py|
