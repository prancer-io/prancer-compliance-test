...
# Master Test ID: PR-AWS-CLD-SGM-001
...
|remediationFunction|PR_AWS_CLD_SGM_001.py|


***<font color="white">Severity:</font>*** High

***<font color="white">Title:</font>*** AWS SageMaker notebook instance not configured with data encryption at rest using KMS key
