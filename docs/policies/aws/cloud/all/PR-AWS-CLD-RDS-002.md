...
# Master Test ID: PR-AWS-CLD-RDS-002
...
|remediationFunction|PR_AWS_CLD_RDS_002.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS RDS database instance is publicly accessible
