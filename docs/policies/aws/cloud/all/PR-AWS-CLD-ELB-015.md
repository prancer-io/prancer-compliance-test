...
# Master Test ID: PR-AWS-CLD-ELB-015
...
***<font color="white">Title:</font>*** Ensure the Load Balancer Listener SSLPolicy is set to at least one value from approved policies
