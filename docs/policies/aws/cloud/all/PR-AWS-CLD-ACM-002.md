...
# Master Test ID: PR-AWS-CLD-ACM-002
...
***<font color="white">Title:</font>*** AWS Certificate Manager (ACM) has certificates with Certificate Transparency Logging disabled
