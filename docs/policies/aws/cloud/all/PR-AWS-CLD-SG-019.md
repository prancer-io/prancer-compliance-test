...
# Master Test ID: PR-AWS-CLD-SG-019
...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-CLD-SG-019|
|eval|data.rule.port_all|
|message|data.rule.port_all_err|
|remediationDescription|Make sure you are following the Cloudformation template format presented <a href='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-security-group.html' target='_blank'>here</a>|
|remediationFunction|PR_AWS_CLD_SG_019.py|


***<font color="white">Severity:</font>*** Low

***<font color="white">Title:</font>*** AWS Default Security Group does not restrict all traffic
