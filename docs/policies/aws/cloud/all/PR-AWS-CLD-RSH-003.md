...
# Master Test ID: PR-AWS-CLD-RSH-003


***<font color="white">Master Snapshot Id:</font>*** ['TEST_REDSHIFT_2']
...
***<font color="white">Title:</font>*** AWS Redshift does not have require_ssl configured
