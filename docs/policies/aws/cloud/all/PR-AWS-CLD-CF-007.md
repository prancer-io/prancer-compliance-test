...
# Master Test ID: PR-AWS-CLD-CF-007
...
***<font color="white">Title:</font>*** AWS CloudFront web distribution with AWS Web Application Firewall (AWS WAF) service disabled
