...
# Master Test ID: PR-AWS-CLD-RDS-008
...
|remediationFunction|PR_AWS_CLD_RDS_008.py|


***<font color="white">Severity:</font>*** Low

***<font color="white">Title:</font>*** AWS RDS instance with copy tags to snapshots disabled
