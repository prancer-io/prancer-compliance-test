...
# Master Test ID: PR-AWS-CLD-KNS-001
...
|remediationFunction|PR_AWS_CLD_KNS_001.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS Kinesis streams are not encrypted using Server Side Encryption
