...
***<font color="white">Title:</font>*** AWS CloudFront origin protocol policy does not enforce HTTPS-only

***<font color="white">Description:</font>*** It is a best security practice to enforce HTTPS-only traffic between a CloudFront distribution and the origin. This policy scans for any deviations from this practice and returns the results.  
