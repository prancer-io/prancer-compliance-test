...
# Master Test ID: PR-AWS-CLD-CF-003
...
|remediationFunction|PR_AWS_CLD_CF_003.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS CloudFront distribution with access logging disabled
