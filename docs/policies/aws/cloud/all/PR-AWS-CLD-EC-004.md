...
# Master Test ID: PR-AWS-CLD-EC-004
...
|remediationFunction|PR_AWS_CLD_EC_004.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS ElastiCache Redis cluster with in-transit encryption disabled
