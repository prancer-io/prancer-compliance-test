...
# Master Test ID: PR-AWS-CLD-RDS-003
...
|remediationFunction|PR_AWS_CLD_RDS_003.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS RDS database not encrypted using Customer Managed Key
