...
# Master Test ID: PR-AWS-CLD-ELB-009
...
***<font color="white">Title:</font>*** AWS Elastic Load Balancer v2 (ELBv2) Application Load Balancer (ALB) with access log disabled
