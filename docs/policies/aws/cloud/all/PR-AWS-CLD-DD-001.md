...
# Master Test ID: PR-AWS-CLD-DD-001
...
|remediationFunction|PR_AWS_CLD_DD_001.py|


***<font color="white">Severity:</font>*** Medium

***<font color="white">Title:</font>*** AWS DynamoDB encrypted using AWS owned CMK instead of AWS managed CMK
