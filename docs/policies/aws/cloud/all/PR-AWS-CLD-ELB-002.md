...
# Master Test ID: PR-AWS-CLD-ELB-002
...
***<font color="white">Title:</font>*** AWS Elastic Load Balancer (Classic) SSL negotiation policy configured with vulnerable SSL protocol
