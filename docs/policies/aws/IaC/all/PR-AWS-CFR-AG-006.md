...
|Title|Description|
| :---: | :---: |
|id|PR-AWS-CFR-AG-006|
|eval|data.rule.gateway_method_public_access|
|message|data.rule.gateway_method_public_access_err|
|remediationDescription|Make sure you are following the Cloudformation template format presented <a href='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-method.html#cfn-apigateway-method-authorizationtype' target='_blank'>here</a>|
|remediationFunction|PR_AWS_CFR_AG_006.py|
...
***<font color="white">Resource Types:</font>*** ['aws::apigateway::method']
