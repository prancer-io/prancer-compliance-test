...
***<font color="white">ID:</font>*** PR-AWS-CFR-MQ-005
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-ES-002
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-NACL-006
...
***<font color="white">ID:</font>*** PR-AWS-CFR-ELB-020
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-S3-003
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-S3-011
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-EFS-002
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-EMR-004
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-IAM-005
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-IAM-020
...
***<font color="white">ID:</font>*** PR-AWS-CFR-SNS-004
...
***<font color="white">ID:</font>*** PR-AWS-CFR-ACM-002
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-ECS-008
...
***<font color="white">ID:</font>*** PR-AWS-CFR-LMD-006
...
***<font color="white">ID:</font>*** PR-AWS-CFR-CF-006
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-RDS-003
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-RDS-011
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-EC-002
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-SG-001
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-SG-009
...
***<font color="white">Master Test ID:</font>*** PR-AWS-CFR-SG-017
...
[AWS ECS/Fargate task definition execution IAM Role not found]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-002.md
[AWS EKS cluster control plane assigned multiple security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-001.md
[AWS EKS unsupported Master node version.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-002.md
[AWS EMR cluster is not configured with CSE CMK for data at rest encryption (Amazon S3 with EMRFS)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-003.md
[AWS EMR cluster is not configured with Kerberos Authentication]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-002.md
[AWS EMR cluster is not configured with security configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-001.md
[AWS EMR cluster is not enabled with data encryption at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-006.md
[AWS EMR cluster is not enabled with data encryption in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-007.md
[AWS EMR cluster is not enabled with local disk encryption using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-004.md
[AWS ElastiCache Redis cluster with Multi-AZ Automatic Failover feature set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-001.md
[AWS ElastiCache Redis cluster with Redis AUTH feature disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-002.md
[AWS ElastiCache Redis cluster with encryption for data at rest disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-003.md
[AWS ElastiCache Redis cluster with in-transit encryption disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-004.md
[AWS Elastic File System (EFS) not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EFS-001.md
[AWS Elastic File System (EFS) with encryption for data at rest disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EFS-002.md
[AWS Elastic Load Balancer (Classic) SSL negotiation policy configured with insecure ciphers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-001.md
[AWS Elastic Load Balancer (Classic) SSL negotiation policy configured with vulnerable SSL protocol]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-002.md
[AWS Elastic Load Balancer (Classic) with access log disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-003.md
[AWS Elastic Load Balancer (Classic) with connection draining disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-004.md
[AWS Elastic Load Balancer (Classic) with cross-zone load balancing disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-005.md
[AWS Elastic Load Balancer (ELB) has security group with no inbound rules]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-006.md
[AWS Elastic Load Balancer (ELB) has security group with no outbound rules]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-007.md
[AWS Elastic Load Balancer (ELB) not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-008.md
[AWS Elastic Load Balancer V2 (ELBV2) with listener TLS/SSL disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-012.md
[AWS Elastic Load Balancer v2 (ELBv2) Application Load Balancer (ALB) with access log disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-009.md
[AWS Elastic Load Balancer with listener TLS/SSL disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-010.md
[AWS ElasticSearch cluster not in a VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-001.md
[AWS Elasticsearch domain Encryption for data at rest is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-002.md
[AWS Elasticsearch domain has Dedicated master set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-003.md
[AWS Elasticsearch domain has Index slow logs set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-004.md
[AWS Elasticsearch domain has Search slow logs set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-005.md
[AWS Elasticsearch domain has Zone Awareness set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-006.md
[AWS Elasticsearch domain is not configured with HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-008.md
[AWS IAM policy allows assume role permission across all services]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-005.md
[AWS IAM policy allows full administrative privileges]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-007.md
[AWS IAM policy is overly permissive to all traffic via condition clause]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-006.md
[AWS KMS Customer Managed Key not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-KMS-002.md
[AWS Kinesis streams are not encrypted using Server Side Encryption]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-KNS-001.md
[AWS Kinesis streams encryption using default KMS keys instead of Customer's Managed Master Keys]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-KNS-002.md
[AWS Lambda Environment Variables not encrypted at-rest using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-001.md
[AWS Lambda Function is not assigned to access within VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-002.md
[AWS Lambda functions with tracing not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-003.md
[AWS MQ is publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MQ-001.md
[AWS Network ACLs with Inbound rule to allow All ICMP IPv4]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-001.md
[AWS Network ACLs with Inbound rule to allow All ICMP IPv6]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-002.md
[AWS Network ACLs with Inbound rule to allow All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-003.md
[AWS Network ACLs with Outbound rule to allow All ICMP IPv4]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-004.md
[AWS Network ACLs with Outbound rule to allow All ICMP IPv6]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-005.md
[AWS Network ACLs with Outbound rule to allow All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-006.md
[AWS RDS DB cluster encryption is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-001.md
[AWS RDS Global DB cluster encryption is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-015.md
[AWS RDS cluster retention policy less than 7 days]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-012.md
[AWS RDS database instance is publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-002.md
[AWS RDS database not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-003.md
[AWS RDS event subscription disabled for DB instance]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-004.md
[AWS RDS event subscription disabled for DB security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-005.md
[AWS RDS instance is not encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-006.md
[AWS RDS instance with Multi-Availability Zone disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-007.md
[AWS RDS instance with copy tags to snapshots disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-008.md
[AWS RDS instance without Automatic Backup setting]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-009.md
[AWS RDS minor upgrades not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-010.md
[AWS RDS retention policy less than 7 days]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-011.md
[AWS Redshift Cluster not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-001.md
[AWS Redshift clusters should not be publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-002.md
[AWS Redshift database does not have audit logging enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-007.md
[AWS Redshift does not have require_ssl configured]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-003.md
[AWS Redshift instances are not encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-004.md
[AWS S3 Bucket has Global DELETE Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-002.md
[AWS S3 Bucket has Global GET Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-003.md
[AWS S3 Bucket has Global LIST Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-004.md
[AWS S3 Bucket has Global PUT Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-005.md
[AWS S3 CloudTrail buckets for which access logging is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-006.md
[AWS S3 Object Versioning is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-007.md
[AWS S3 bucket has global view ACL permissions enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-008.md
[AWS S3 bucket not configured with secure data transport policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-009.md
[AWS S3 buckets are accessible to any authenticated user.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-010.md
[AWS S3 buckets are accessible to public]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-011.md
[AWS S3 buckets do not have server side encryption.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-012.md
[AWS SNS subscription is not configured with HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-001.md
[AWS SNS topic encrypted using default KMS key instead of CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-002.md
[AWS SNS topic with server-side encryption disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-003.md
[AWS SQS does not have a dead letter queue configured]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-001.md
[AWS SQS queue encryption using default KMS key instead of CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-002.md
[AWS SQS server side encryption not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-003.md
[AWS SageMaker notebook instance configured with direct internet access feature]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SGM-003.md
[AWS SageMaker notebook instance is not placed in VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SGM-004.md
[AWS SageMaker notebook instance not configured with data encryption at rest using KMS key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SGM-001.md
[AWS SageMaker notebook instance with root access enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SGM-002.md
[AWS Security Groups allow internet traffic from internet to CIFS port (445)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-014.md
[AWS Security Groups allow internet traffic from internet to DNS port (53)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-015.md
[AWS Security Groups allow internet traffic from internet to ElasticSearch Protocol Port (9300)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-024.md
[AWS Security Groups allow internet traffic from internet to FTP port (21)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-007.md
[AWS Security Groups allow internet traffic from internet to FTP-Data port (20)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-006.md
[AWS Security Groups allow internet traffic from internet to Kibana Protocol Port (5601)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-025.md
[AWS Security Groups allow internet traffic from internet to MSQL port (4333)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-013.md
[AWS Security Groups allow internet traffic from internet to MYSQL port (3306)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-011.md
[AWS Security Groups allow internet traffic from internet to Microsoft Operations Manager Protocol Port (1270)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-029.md
[AWS Security Groups allow internet traffic from internet to NetBIOS port (137)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-002.md
[AWS Security Groups allow internet traffic from internet to NetBIOS port (138)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-003.md
[AWS Security Groups allow internet traffic from internet to PostgreSQL port (5432)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-016.md
[AWS Security Groups allow internet traffic from internet to RDP port (3389)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-012.md
[AWS Security Groups allow internet traffic from internet to SMTP port (25)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-010.md
[AWS Security Groups allow internet traffic from internet to SQLServer port (1433)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-004.md
[AWS Security Groups allow internet traffic from internet to SQLServer port (1434)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-005.md
[AWS Security Groups allow internet traffic from internet to Telnet port (23)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-009.md
[AWS Security Groups allow internet traffic from internet to Trivial File Transfer Protocol Port (69)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-021.md
[AWS Security Groups allow internet traffic from internet to VNC Listener port (5500)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-017.md
[AWS Security Groups allow internet traffic from internet to VNC Server port (5900)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-018.md
[AWS Security Groups allow internet traffic from internet to WinRM 2.0 (Microsoft Windows Remote Management) Protocol Port (5985)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-028.md
[AWS Security Groups allow internet traffic from internet to WinRM 2.0 (Microsoft Windows Remote Management) Protocol Port (5986)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-027.md
[AWS Security Groups allow internet traffic from internet to Windows RPC port (135)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-001.md
[AWS Security Groups allow internet traffic from internet to etcd-client Protocol Port (2379)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-026.md
[AWS Security Groups allow internet traffic to SSH port (22)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-008.md
[AWS Security Groups with Inbound rule overly permissive to All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-020.md
[AWS VPC subnets should not allow automatic public IP assignment]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-VPC-001.md
[CloudTrail trail is not integrated with CloudWatch Log]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CT-004.md
[Code Pipeline Encryption at rest with customer-managed key (CMK) should be enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CP-001.md
[Dynamo DB kinesis specification property should not be null]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DD-003.md
[Elasticsearch Domain should not have Encrytion using AWS Managed Keys]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-009.md
[Enable AWS Inspector to detect Vulnerability]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-INS-001.md
[Enhanced monitoring for Amazon RDS instances is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-019.md
[Ensure 'default' value is not used on Security Group setting for Redis cache engines]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-006.md
[Ensure ACM Certification Validation Method set to DNS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ACM-004.md
[Ensure API Gateway has tracing enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AG-005.md
[Ensure API gateway methods are not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AG-006.md
[Ensure AWS API Gateway uses TLS 1.2 in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AG-009.md
[Ensure AWS CloudTrail is logging data events for S3 and Lambda.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CT-005.md
[Ensure AWS Config includes global resources types (IAM).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CFG-004.md
[Ensure AWS DAX data is encrypted in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DAX-002.md
[Ensure AWS DocumentDB logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DDB-002.md
[Ensure AWS EC2 EBS and Network components' deletion protection is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC2-006.md
[Ensure AWS ECR Repository is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-004.md
[Ensure AWS EKS cluster has secrets encryption enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-003.md
[Ensure AWS EKS control plane logging is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-009.md
[Ensure AWS EKS only uses latest versions of Kubernetes.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-006.md
[Ensure AWS Glue encrypt data at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-GLUE-003.md
[Ensure AWS Glue security configuration encryption is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-GLUE-002.md
[Ensure AWS IAM policy do not have permission which may cause privilege escalation.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-027.md
[Ensure AWS IAM policy does not allows decryption actions on all KMS keys.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-041.md
[Ensure AWS IAM policy is not overly permissive to STS services.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-044.md
[Ensure AWS Lambda function is configured for a DLQ]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-005.md
[Ensure AWS Lambda function is configured for function-level concurrent execution limit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-004.md
[Ensure AWS RDS Cluster has setup backup retention period of at least 30 days.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-028.md
[Ensure AWS RDS DB authentication is only enabled via IAM.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-027.md
[Ensure AWS RDS DB instance has deletion protection enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-029.md
[Ensure AWS Redshift - Enhanced VPC routing must be enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-008.md
[Ensure AWS S3 bucket do not have policy that is overly permissive to VPC endpoints.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-025.md
[Ensure AWS S3 bucket has a policy attached.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-024.md
[Ensure AWS S3 bucket policy is not overly permissive to any principal.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-023.md
[Ensure AWS SNS Topic is not publicly accessible through IAM policies.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-045.md
[Ensure AWS SNS topic do not have cross-account access.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-008.md
[Ensure AWS SNS topic is not exposed to unauthorized access.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-005.md
[Ensure AWS SNS topic policy is not overly permissive for publishing.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-006.md
[Ensure AWS SNS topic policy is not overly permissive for subscription.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-007.md
[Ensure AWS SQS queue access policy is not overly permissive.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-006.md
[Ensure AWS SageMaker notebook instance IAM policy is not overly permissive to all traffic.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-046.md
[Ensure AWS Secrets Manager automatic rotation is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SM-003.md
[Ensure AWS VPC endpoint policy is not overly permissive.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-VPC-006.md
[Ensure AWS WorkSpaces do not use directory type Simple AD.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-WS-003.md
[Ensure AWS config is enabled in all regions]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CFG-002.md
[Ensure AWS resources that support tags have Tags]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-022.md
[Ensure AWS secret rotation period is per the GS standard (Ex: 30 days).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SM-004.md
[Ensure ActiveMQ engine version is approved by GS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MQ-003.md
[Ensure Amazon MQ Broker logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MQ-002.md
[Ensure Amazon MSK cluster has logging enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-005.md
[Ensure Amazon Machine Image (AMI) is not infected with mining malware.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC2-007.md
[Ensure AppSync is configured with AWS Web Application Firewall v2.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-APS-001.md
[Ensure Athena logging is enabled for athena workgroup.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ATH-002.md
[Ensure CloudWatch Alarm Metrics AccountId is valid]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CW-001.md
[Ensure CloudWatch log groups are encrypted with KMS CMKs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LG-001.md
[Ensure CloudWatch log groups has retention days defined]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LG-002.md
[Ensure Cluster level logging is enabled for EMR.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-008.md
[Ensure CodeBuild project Artifact encryption is not disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CB-001.md
[Ensure DAX is securely encrypted at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DAX-001.md
[Ensure DMS endpoints are supporting SSL configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DMS-001.md
[Ensure DMS replication instance is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DMS-002.md
[Ensure DocDB ParameterGroup has TLS enable]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DDB-003.md
[Ensure DocDB has audit logs enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DDB-004.md
[Ensure DocumentDB cluster is encrypted at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DDB-001.md
[Ensure DynamoDB PITR is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-DD-002.md
[Ensure EBS volumes are encrypted using Customer Managed Key (CMK)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC2-010.md
[Ensure EBS volumes have encrypted launch configurations]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AS-001.md
[Ensure EC2 Auto Scaling Group does not launch IMDSv1]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AS-003.md
[Ensure EC2 instance that is not internet reachable with unrestricted access (0.0.0.0/0) other than HTTP/HTTPS port monitoring is enabled for EC2 instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-034.md
[Ensure ECR image scan on push is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-003.md
[Ensure ECR image tags are immutable]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-001.md
[Ensure ECR repositories are encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-002.md
[Ensure ECR resources are accessible only via private endpoint.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-006.md
[Ensure ECS Services and Task Set EnableExecuteCommand property set to False]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-009.md
[Ensure EFS volumes in ECS task definitions have encryption in transit enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-007.md
[Ensure EKS cluster is configured with control plane security group attached to it.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-007.md
[Ensure EMR cluster is not visible to all IAM users.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EMR-009.md
[Ensure Elastic Load Balancer v2 (ELBv2) SSL negotiation policy is not configured with weak ciphers.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-025.md
[Ensure ElasticSearch has a custom endpoint configured.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-010.md
[Ensure General and Audit logs are published to CloudWatch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MQ-005.md
[Ensure Glacier Backup policy is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-BKP-001.md
[Ensure Glue Data Catalog encryption is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-GLUE-001.md
[Ensure IAM groups contains at least one IAM user]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-008.md
[Ensure IAM policy is attached to group rather than user.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-042.md
[Ensure IAM policy is not overly permissive to Lambda service]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-012.md
[Ensure IAM policy is not overly permissive to all traffic for ecs.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-029.md
[Ensure IAM policy is not overly permissive to all traffic for elasticsearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-030.md
[Ensure IAM policy is not overly permissive to all traffic via condition clause.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-043.md
[Ensure Internet facing Classic ELB is not in use.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-022.md
[Ensure Internet facing ELBV2 is not in use.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-023.md
[Ensure Kubernetes secrets are encrypted using CMKs managed in AWS KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-004.md
[Ensure Lambda IAM policy is not overly permissive to all traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-011.md
[Ensure LoadBalancer TargetGroup Protocol values are limited to HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-019.md
[Ensure LoadBalancer scheme is set to internal and not internet-facing]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-017.md
[Ensure MSK cluster is setup in GS VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-004.md
[Ensure Neptune logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NPT-001.md
[Ensure PGAudit is enabled on RDS Postgres instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-014.md
[Ensure QLDB ledger permissions mode is set to STANDARD]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-QLDB-001.md
[Ensure RDS DB instance has setup backup retention period of at least 30 days.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-030.md
[Ensure RDS cluster do not use a deprecated version of Aurora-PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-022.md
[Ensure RDS cluster has IAM authentication enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-016.md
[Ensure RDS clusters and instances have deletion protection enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-013.md
[Ensure RDS dbcluster do not use a deprecated version of PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-024.md
[Ensure RDS instace has IAM authentication enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-017.md
[Ensure RDS instances do not use a deprecated version of Aurora-PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-021.md
[Ensure RDS instances do not use a deprecated version of PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-023.md
[Ensure RDS instances uses AWS Secrets Manager for credentials.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-020.md
[Ensure RabbitMQ engine version is approved by GS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MQ-004.md
[Ensure Redshift cluster allow version upgrade by default]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-005.md
[Ensure Redshift database clusters are not using default master username.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-011.md
[Ensure Redshift database clusters are not using default port(5439) for database connection.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-012.md
[Ensure Redshift is not deployed outside of a VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-006.md
[Ensure Route53 DNS evaluateTargetHealth is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-R53-001.md
[Ensure S3 Bucket BlockPublicPolicy is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-021.md
[Ensure S3 Bucket NotificationConfiguration Property is not set.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-022.md
[Ensure S3 Bucket has public access blocks]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-018.md
[Ensure S3 bucket IgnorePublicAcls is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-020.md
[Ensure S3 bucket RestrictPublicBucket is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-019.md
[Ensure S3 bucket cross-region replication is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-017.md
[Ensure S3 bucket has enabled lock configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-016.md
[Ensure S3 bucket is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-015.md
[Ensure S3 hosted sites supported hardened CORS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-014.md
[Ensure SNS Topic policy is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-004.md
[Ensure SNS is only accessible via specific VPCe service.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-009.md
[Ensure SNS topic is configured with secure data transport policy.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SNS-010.md
[Ensure SQS data is encrypted in Transit using SSL/TLS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-008.md
[Ensure SQS is only accessible via specific VPCe service.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-007.md
[Ensure SQS policy documents do not allow all actions]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-005.md
[Ensure SQS queue policy is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SQS-004.md
[Ensure Security groups has attached to a VPCs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-033.md
[Ensure Slow Logs feature is enabled for ElasticSearch cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-011.md
[Ensure Synthetic canary has defined ArtifactS3Locaton]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SC-001.md
[Ensure Synthetics Canary VPCConfig Security Groups are attached to VPC Config]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SC-003.md
[Ensure Synthetics Canary is attached to the Shared VPC.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SC-002.md
[Ensure Timestream database is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-TS-001.md
[Ensure Transfer Server is not publicly exposed]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-TRF-001.md
[Ensure Transfer Server is not use FTP protocol.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-TRF-002.md
[Ensure VPC endpoint service is configured for manual acceptance]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-VPC-003.md
[Ensure all EIP addresses allocated to a VPC are attached related EC2 instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-VPC-002.md
[Ensure all load balancers created are application load balancers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-018.md
[Ensure auto scaling groups associated with a load balancer use elastic load balancing health checks]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AS-002.md
[Ensure automated backups are enabled for Redshift cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RSH-013.md
[Ensure client authentication is enabled with TLS (mutual TLS authentication)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-003.md
[Ensure communication to and from EKS remains private.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-005.md
[Ensure container insights are enabled on ECS cluster]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-008.md
[Ensure content encoding is enabled for API Gateway.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AG-010.md
[Ensure data is Encrypted in transit (TLS)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-002.md
[Ensure detailed monitoring is enabled for EC2 instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC2-005.md
[Ensure enhanaced monitoring for AWS MSK is not set to default.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-006.md
[Ensure every Security Group rule contains a description]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-023.md
[Ensure fine-grained access control is enabled during domain creation in ElasticSearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-013.md
[Ensure in AWS ElastiCache, automatic backups is enabled for Redis cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-007.md
[Ensure lifecycle policy is enabled for ECR image repositories.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECR-007.md
[Ensure no IAM policy has a resource specified in the following format:'arn:aws:*:*']: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-004.md
[Ensure no KMS key policy contain wildcard (*) principal]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-KMS-003.md
[Ensure no hardcoded password set in the template]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-0031-RGX.md
[Ensure no wildcards are specified in IAM Managed policy with 'Resource' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-009.md
[Ensure no wildcards are specified in IAM policy with 'Action' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-002.md
[Ensure no wildcards are specified in IAM policy with 'Resource' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-001.md
[Ensure no wildcards are specified in IAM trust-relationship policy with 'Principal' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-003.md
[Ensure node-to-node encryption is enabled on each ElasticSearch Domain]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ES-007.md
[Ensure one of Subnets or SubnetMappings is defined for loadbalancer]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-016.md
[Ensure only private access for Amazon EKS cluster's Kubernetes API is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EKS-008.md
[Ensure public access is disabled for AWS MSK.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-007.md
[Ensure respective logs of Amazon RDS instance are enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-RDS-018.md
[Ensure that API Gateway has enabled access logging]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-AG-004.md
[Ensure that AWS Ensure Elastic Load Balancer v2 (ELBv2) has deletion protection feature enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-020.md
[Ensure that AWS ensure Gateway Load Balancer (GWLB) is not being used.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-021.md
[Ensure that Application Load Balancer drops HTTP headers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-013.md
[Ensure that CodeBuild projects are encrypted using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-CB-002.md
[Ensure that EC2 instace is EBS Optimized]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC2-004.md
[Ensure that ECS Service and Task Set network configuration disallows the assignment of public IPs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-010.md
[Ensure that ECS Task Definition have their network mode property set to awsvpc]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-014.md
[Ensure that ECS services and Task Sets are launched as Fargate type]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-011.md
[Ensure that ELB Listener is limited to approved actions.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-026.md
[Ensure that ElastiCache replication Group (Redis) are encrypted at rest with customer managed CMK key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-EC-005.md
[Ensure that Listeners redirect using only the HTTPS protocol.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-027.md
[Ensure that Secrets Manager secret is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SM-001.md
[Ensure that SecretsManager RotationSchedule HostedRotationLambda attaches to a VPC Subnet IDs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SM-002.md
[Ensure that Workspace root volumes is encrypted.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-WS-002.md
[Ensure that Workspace user volumes is encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-WS-001.md
[Ensure that a log driver has been configured for each ECS task definition.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-017.md
[Ensure that public facing ELB has WAF attached]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-024.md
[Ensure that the AWS EC2 instances don't have a risky set of permissions management access to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-013.md
[Ensure that the AWS EC2 instances provisioned in your AWS account don't have a risky set of write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-016.md
[Ensure that the AWS ECR Repository resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-022.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of org write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-017.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of permissions management access permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-015.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-014.md
[Ensure that the AWS Lambda Function resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-023.md
[Ensure that the AWS S3 bucket resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-024.md
[Ensure that the AWS SQS Queue resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-025.md
[Ensure that the AWS Secret Manager Secret resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-026.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of ec2.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-019.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of ecs task definition.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-021.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of elastic bean stalk.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-018.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of lambda function.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-020.md
[Ensure that the CertificateManager certificates reference only Private ACMPCA certificate authorities]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ACM-003.md
[Ensure that the Route53 RecordSet Type is A or CNAME.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-R53-002.md
[Ensure the ELBv2 ListenerCertificate ListenerArn value is defined]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-014.md
[Ensure the Load Balancer Listener SSLPolicy is set to at least one value from approved policies]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ELB-015.md
[Ensure there are no undefined ECS task definition empty roles for ECS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-016.md
[Ensure to enable EnforceWorkGroupConfiguration for athena workgroup]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ATH-001.md
[Ensure unsupported properties on Lambda EventSourceMapping are not set.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-006.md
[IAM Roles should not have names that start with "cdk" or "cft".]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-IAM-010.md
[Instance is communicating with ports known to mine Bitcoin]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-031.md
[Instance is communicating with ports known to mine Ethereum]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-032.md
[JMSAppender in Log4j 1.2 is vulnerable to deserialization of untrusted data when the attacker has write access to the Log4j configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-WAF-001.md
[Lambda Function PackageType value is limited to Zip]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-007.md
[Limit lambda runtimes to allowed list]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-LMD-008.md
[Publicly exposed DB Ports]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-SG-030.md
[S3 buckets with configurations set to host websites]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-S3-013.md
[There is a possibility that AWS account ID has leaked]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-0029-RGX.md
[There is a possibility that AWS secret access key has leaked]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-0028-RGX.md
[There is a possibility that Aws access key id is exposed]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-0030-RGX.md
[There is a possibility that a value might contains a secret string or password]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-0032-RGX.md
[Unrestricted Inbound Traffic on Remote Server Administration Ports]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-NACL-007.md
[Use KMS Customer Master Keys for AWS MSK Clusters]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-MSK-001.md
[VPC configurations on ECS Services and TaskSets must use either vended security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-013.md
[Value(s) of subnets attached to aws ecs service or taskset AwsVpcConfiguration resources are vended]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/IaC/all/PR-AWS-CFR-ECS-012.md
