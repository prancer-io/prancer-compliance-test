...
[AWS Config must record all possible resources]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFG-001.md
[AWS Customer Master Key (CMK) rotation is not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KMS-001.md
[AWS Default Security Group does not restrict all traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-019.md
[AWS DynamoDB encrypted using AWS owned CMK instead of AWS managed CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DD-001.md
[AWS EBS volumes are not encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EBS-001.md
[AWS EC2 Instance IAM Role not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-001.md
[AWS EC2 instance is not configured with VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-002.md
[AWS EC2 instances with Public IP and associated with Security Groups have Internet Access]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-003.md
[AWS ECS - Ensure Fargate task definition logging is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-015.md
[AWS ECS Task Definition readonlyRootFilesystem Not Enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-004.md
[AWS ECS task definition elevated privileges enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-001.md
[AWS ECS task definition logging not enabled. or only valid option for LogDriver is 'awslogs']: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-006.md
[AWS ECS task definition resource limits not set.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-005.md
[AWS ECS/ Fargate task definition root user found]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-003.md
[AWS ECS/Fargate task definition execution IAM Role not found]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-002.md
[AWS EKS cluster control plane assigned multiple security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-001.md
[AWS EMR cluster is not configured with CSE CMK for data at rest encryption (Amazon S3 with EMRFS)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-003.md
[AWS EMR cluster is not configured with Kerberos Authentication]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-002.md
[AWS EMR cluster is not configured with security configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-001.md
[AWS EMR cluster is not enabled with data encryption at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-006.md
[AWS EMR cluster is not enabled with data encryption in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-007.md
[AWS EMR cluster is not enabled with local disk encryption using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-004.md
[AWS ElastiCache Redis cluster with Multi-AZ Automatic Failover feature set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-001.md
[AWS ElastiCache Redis cluster with Redis AUTH feature disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-002.md
[AWS ElastiCache Redis cluster with encryption for data at rest disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-003.md
[AWS ElastiCache Redis cluster with in-transit encryption disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-004.md
[AWS Elastic File System (EFS) not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EFS-001.md
[AWS Elastic File System (EFS) with encryption for data at rest disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EFS-002.md
[AWS Elastic Load Balancer (Classic) SSL negotiation policy configured with insecure ciphers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-001.md
[AWS Elastic Load Balancer (Classic) SSL negotiation policy configured with vulnerable SSL protocol]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-002.md
[AWS Elastic Load Balancer (Classic) with access log disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-003.md
[AWS Elastic Load Balancer (Classic) with connection draining disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-004.md
[AWS Elastic Load Balancer (Classic) with cross-zone load balancing disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-005.md
[AWS Elastic Load Balancer (ELB) not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-008.md
[AWS Elastic Load Balancer V2 (ELBV2) with listener TLS/SSL disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-012.md
[AWS Elastic Load Balancer v2 (ELBv2) Application Load Balancer (ALB) with access log disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-009.md
[AWS Elastic Load Balancer with listener TLS/SSL disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-010.md
[AWS ElasticSearch cluster not in a VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-001.md
[AWS Elasticsearch domain Encryption for data at rest is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-002.md
[AWS Elasticsearch domain has Dedicated master set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-003.md
[AWS Elasticsearch domain has Index slow logs set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-004.md
[AWS Elasticsearch domain has Search slow logs set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-005.md
[AWS Elasticsearch domain has Zone Awareness set to disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-006.md
[AWS Elasticsearch domain is not configured with HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-008.md
[AWS IAM policy allows assume role permission across all services]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-005.md
[AWS IAM policy allows full administrative privileges]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-007.md
[AWS IAM policy is overly permissive to all traffic via condition clause]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-006.md
[AWS KMS Customer Managed Key not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KMS-002.md
[AWS Kinesis streams are not encrypted using Server Side Encryption]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KNS-001.md
[AWS Kinesis streams encryption using default KMS keys instead of Customer's Managed Master Keys]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KNS-002.md
[AWS Lambda Environment Variables not encrypted at-rest using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LMD-001.md
[AWS Lambda Function is not assigned to access within VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LMD-002.md
[AWS Lambda functions with tracing not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LMD-003.md
[AWS MQ is publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MQ-001.md
[AWS Network ACLs with Inbound rule to allow All ICMP IPv4]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-001.md
[AWS Network ACLs with Inbound rule to allow All ICMP IPv6]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-002.md
[AWS Network ACLs with Inbound rule to allow All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-003.md
[AWS Network ACLs with Outbound rule to allow All ICMP IPv4]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-004.md
[AWS Network ACLs with Outbound rule to allow All ICMP IPv6]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-005.md
[AWS Network ACLs with Outbound rule to allow All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-006.md
[AWS RDS DB cluster encryption is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-001.md
[AWS RDS Global DB cluster encryption is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-015.md
[AWS RDS cluster retention policy less than 7 days]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-012.md
[AWS RDS database instance is publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-002.md
[AWS RDS database not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-003.md
[AWS RDS event subscription disabled for DB instance]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-004.md
[AWS RDS event subscription disabled for DB security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-005.md
[AWS RDS instance is not encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-006.md
[AWS RDS instance with Multi-Availability Zone disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-007.md
[AWS RDS instance with copy tags to snapshots disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-008.md
[AWS RDS instance without Automatic Backup setting]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-009.md
[AWS RDS minor upgrades not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-010.md
[AWS RDS retention policy less than 7 days]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-011.md
[AWS Redshift Cluster not encrypted using Customer Managed Key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-001.md
[AWS Redshift clusters should not be publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-002.md
[AWS Redshift database does not have audit logging enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-007.md
[AWS Redshift does not have require_ssl configured]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-003.md
[AWS Redshift instances are not encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-004.md
[AWS S3 Bucket has Global DELETE Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-002.md
[AWS S3 Bucket has Global get Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-003.md
[AWS S3 Bucket has Global list Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-004.md
[AWS S3 Bucket has Global put Permissions enabled via bucket policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-005.md
[AWS S3 CloudTrail buckets for which access logging is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-006.md
[AWS S3 Object Versioning is disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-007.md
[AWS S3 bucket not configured with secure data transport policy]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-009.md
[AWS S3 buckets do not have server side encryption.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-012.md
[AWS SNS subscription is not configured with HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-001.md
[AWS SNS topic encrypted using default KMS key instead of CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-002.md
[AWS SNS topic with server-side encryption disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-003.md
[AWS SQS does not have a dead letter queue configured]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-001.md
[AWS SQS queue encryption using default KMS key instead of CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-002.md
[AWS SQS server side encryption not enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-003.md
[AWS SageMaker notebook instance configured with direct internet access feature]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SGM-003.md
[AWS SageMaker notebook instance is not placed in VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SGM-004.md
[AWS SageMaker notebook instance not configured with data encryption at rest using KMS key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SGM-001.md
[AWS SageMaker notebook instance with root access enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SGM-002.md
[AWS Security Groups allow internet traffic from internet to CIFS port (445)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-014.md
[AWS Security Groups allow internet traffic from internet to DNS port (53)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-015.md
[AWS Security Groups allow internet traffic from internet to ElasticSearch Protocol Port (9300)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-024.md
[AWS Security Groups allow internet traffic from internet to FTP port (21)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-007.md
[AWS Security Groups allow internet traffic from internet to FTP-Data port (20)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-006.md
[AWS Security Groups allow internet traffic from internet to Kibana Protocol Port (5601)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-025.md
[AWS Security Groups allow internet traffic from internet to MSQL port (4333)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-013.md
[AWS Security Groups allow internet traffic from internet to MYSQL port (3306)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-011.md
[AWS Security Groups allow internet traffic from internet to Microsoft Operations Manager Protocol Port (1270)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-029.md
[AWS Security Groups allow internet traffic from internet to NetBIOS port (137)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-002.md
[AWS Security Groups allow internet traffic from internet to NetBIOS port (138)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-003.md
[AWS Security Groups allow internet traffic from internet to PostgreSQL port (5432)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-016.md
[AWS Security Groups allow internet traffic from internet to RDP port (3389)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-012.md
[AWS Security Groups allow internet traffic from internet to SMTP port (25)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-010.md
[AWS Security Groups allow internet traffic from internet to SQLServer port (1433)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-004.md
[AWS Security Groups allow internet traffic from internet to SQLServer port (1434)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-005.md
[AWS Security Groups allow internet traffic from internet to Telnet port (23)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-009.md
[AWS Security Groups allow internet traffic from internet to Trivial File Transfer Protocol Port (69)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-021.md
[AWS Security Groups allow internet traffic from internet to VNC Listener port (5500)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-017.md
[AWS Security Groups allow internet traffic from internet to VNC Server port (5900)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-018.md
[AWS Security Groups allow internet traffic from internet to WinRM 2.0 (Microsoft Windows Remote Management) Protocol Port (5985)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-028.md
[AWS Security Groups allow internet traffic from internet to WinRM 2.0 (Microsoft Windows Remote Management) Protocol Port (5986)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-027.md
[AWS Security Groups allow internet traffic from internet to Windows RPC port (135)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-001.md
[AWS Security Groups allow internet traffic from internet to etcd-client Protocol Port (2379)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-026.md
[AWS Security Groups allow internet traffic to SSH port (22)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-008.md
[AWS Security Groups with Inbound rule overly permissive to All Traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-020.md
[AWS VPC subnets should not allow automatic public IP assignment]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-001.md
[CloudTrail trail is not integrated with CloudWatch Log]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CT-004.md
[Code Pipeline Encryption at rest with customer-managed key (CMK) should be enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CP-001.md
[Elasticsearch Domain should not have Encrytion using AWS Managed Keys]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-009.md
[Enable AWS Inspector to detect Vulnerability]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-INS-001.md
[Enable Enhanced scan type for AWS ECR registry to detect vulnerability]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-005.md
[Enhanced monitoring for Amazon RDS instances is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-019.md
[Ensure API Gateway has tracing enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-005.md
[Ensure API gateway methods are not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-006.md
[Ensure AWS API Gateway uses TLS 1.2 in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-009.md
[Ensure AWS Amazon Machine Image (AMI) is not publicly accessible.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-009.md
[Ensure AWS Certificate Manager (ACM) does not contain certificate pending validation.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ACM-006.md
[Ensure AWS Certificate Manager (ACM) does not have invalid or failed certificate.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ACM-007.md
[Ensure AWS CloudTrail is enabled on the account.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CT-006.md
[Ensure AWS CloudTrail is logging data events for S3 and Lambda.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CT-005.md
[Ensure AWS CloudTrail logging is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CT-007.md
[Ensure AWS CloudTrail logs is integrated with CloudWatch for all regions.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CT-008.md
[Ensure AWS Config does not fail to deliver log files]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFG-003.md
[Ensure AWS Config includes global resources types (IAM).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFG-004.md
[Ensure AWS DAX data is encrypted in transit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DAX-002.md
[Ensure AWS DocumentDB logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DDB-002.md
[Ensure AWS DynamoDB does not uses customer managed CMK key to ensure encryption at rest.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DD-004.md
[Ensure AWS EBS snapshots are not accessible to public]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-008.md
[Ensure AWS EC2 EBS and Network components' deletion protection is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-006.md
[Ensure AWS EC2 instance is configured with Instance Metadata Service v2 (IMDSv2).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-013.md
[Ensure AWS ECR Repository is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-004.md
[Ensure AWS ECS cluster is configured with active services.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-018.md
[Ensure AWS EKS cluster has secrets encryption enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-003.md
[Ensure AWS EKS control plane logging is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-009.md
[Ensure AWS EKS only uses latest versions of Kubernetes.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-006.md
[Ensure AWS ElastiCache cluster is associated with VPC.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-010.md
[Ensure AWS Glue encrypt data at rest with GS managed Customer Master Key (CMK).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-GLUE-004.md
[Ensure AWS Glue encrypt data at rest.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-GLUE-003.md
[Ensure AWS Glue security configuration encryption is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-GLUE-002.md
[Ensure AWS IAM policy do not have permission which may cause privilege escalation.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-027.md
[Ensure AWS IAM policy does not allows decryption actions on all KMS keys.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-041.md
[Ensure AWS IAM policy is not overly permissive to STS services.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-044.md
[Ensure AWS KMS Key is not scheduled for deletion.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KMS-004.md
[Ensure AWS Lambda function is configured for a DLQ]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LMD-005.md
[Ensure AWS Lambda function is configured for function-level concurrent execution limit]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LMD-004.md
[Ensure AWS RDS Cluster has setup backup retention period of at least 30 days]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-028.md
[Ensure AWS RDS DB authentication is only enabled via IAM]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-027.md
[Ensure AWS RDS DB cluster is not encrypted using default KMS key instead of CMK.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-031.md
[Ensure AWS RDS DB instance has deletion protection enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-029.md
[Ensure AWS RDS DB snapshot is encrypted.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-025.md
[Ensure AWS RDS Snapshot with access for only monitored cloud accounts.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-026.md
[Ensure AWS Redshift - Enhanced VPC routing must be enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-008.md
[Ensure AWS S3 bucket do not have policy that is overly permissive to VPC endpoints.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-025.md
[Ensure AWS S3 bucket has a policy attached.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-024.md
[Ensure AWS S3 bucket policy is not overly permissive to any principal.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-023.md
[Ensure AWS SNS Topic is not publicly accessible through IAM policies.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-045.md
[Ensure AWS SNS topic do not have cross-account access.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-008.md
[Ensure AWS SNS topic is not exposed to unauthorized access.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-005.md
[Ensure AWS SNS topic policy is not overly permissive for publishing.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-006.md
[Ensure AWS SNS topic policy is not overly permissive for subscription.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-007.md
[Ensure AWS SQS queue access policy is not overly permissive.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-006.md
[Ensure AWS SageMaker notebook instance IAM policy is not overly permissive to all traffic.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-046.md
[Ensure AWS SageMaker notebook instance is encrypted using Customer Managed Key.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SGM-005.md
[Ensure AWS Secrets Manager automatic rotation is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SM-003.md
[Ensure AWS VPC endpoint policy is not overly permissive.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-006.md
[Ensure AWS WorkSpaces do not use directory type Simple AD.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-WS-003.md
[Ensure AWS config is enabled in all regions]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFG-002.md
[Ensure AWS resources that support tags have Tags]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-022.md
[Ensure AWS secret rotation period is per the GS standard (Ex: 30 days).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SM-004.md
[Ensure ActiveMQ engine version is approved by GS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MQ-003.md
[Ensure Amazon MQ Broker logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MQ-002.md
[Ensure Amazon MSK cluster has logging enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-005.md
[Ensure Amazon Machine Image (AMI) is not infected with mining malware.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-007.md
[Ensure Athena logging is enabled for athena workgroup.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ATH-002.md
[Ensure Certificate Manager (ACM) does not have unused certificates.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ACM-005.md
[Ensure CloudFormation template is configured with stack policy.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFR-002.md
[Ensure CloudWatch log groups are encrypted with KMS CMKs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LG-001.md
[Ensure CloudWatch log groups has retention days defined]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-LG-002.md
[Ensure Cloudformation rollback is disabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFR-003.md
[Ensure Cluster level logging is enabled for EMR.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-008.md
[Ensure CodeBuild project Artifact encryption is not disabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CB-001.md
[Ensure DAX is securely encrypted at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DAX-001.md
[Ensure DMS endpoints are supporting SSL configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DMS-001.md
[Ensure DMS replication instance in encrypted by GS provided CMK.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DMS-004.md
[Ensure DMS replication instance is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DMS-002.md
[Ensure Database Migration Service (DMS) has not expired certificates]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DMS-003.md
[Ensure DocDB ParameterGroup has TLS enable]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DDB-003.md
[Ensure DocDB has audit logs enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DDB-004.md
[Ensure DocumentDB cluster is encrypted at rest]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DDB-001.md
[Ensure DynamoDB PITR is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DD-002.md
[Ensure EBS deletion protection is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-012.md
[Ensure EBS volume is attached]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-011.md
[Ensure EBS volumes have encrypted launch configurations]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AS-001.md
[Ensure EC2 Auto Scaling Group does not launch IMDSv1]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AS-003.md
[Ensure EC2 is communicating with other services outside VPC using VPC-endpoint.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-014.md
[Ensure ECR image scan on push is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-003.md
[Ensure ECR image tags are immutable]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-001.md
[Ensure ECR is encrypted using dedicated GS managed KMS key.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-008.md
[Ensure ECR repositories are encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-002.md
[Ensure ECR resources are accessible only via private endpoint.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-006.md
[Ensure ECS Services and Task Set EnableExecuteCommand property set to False]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-009.md
[Ensure EFS volumes in ECS task definitions have encryption in transit enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-007.md
[Ensure EKS cluster is configured with control plane security group attached to it.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-007.md
[Ensure EKS cluster is not using the default VPC.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-011.md
[Ensure EMR cluster is not visible to all IAM users.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-009.md
[Ensure ElastiCache (Redis) replicationGroupId is not empty or contains wildcards (*).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-009.md
[Ensure ElastiCache Redis with in-transit encryption is disabled (Non-replication group).]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-008.md
[Ensure Elastic Load Balancer v2 (ELBv2) SSL negotiation policy is not configured with weak ciphers.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-025.md
[Ensure ElasticSearch has a custom endpoint configured.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-010.md
[Ensure ElasticSearch is encrypted at rest with GS managed KMS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-016.md
[Ensure Elasticsearch domain is not publicly accessible.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-015.md
[Ensure GS-managed encryption key is used for AWS EKS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-010.md
[Ensure General and Audit logs are published to CloudWatch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MQ-005.md
[Ensure Glue Data Catalog encryption is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-GLUE-001.md
[Ensure IAM groups contains at least one IAM user]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-008.md
[Ensure IAM policy is attached to group rather than user.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-042.md
[Ensure IAM policy is not overly permissive to Lambda service]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-012.md
[Ensure IAM policy is not overly permissive to all traffic for ecs.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-029.md
[Ensure IAM policy is not overly permissive to all traffic for elasticsearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-030.md
[Ensure IAM policy is not overly permissive to all traffic via condition clause.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-043.md
[Ensure Internet facing Classic ELB is not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-022.md
[Ensure Internet facing Classic ELBV2 is not in use]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-023.md
[Ensure Kinesis streams are encrypted using dedicated GS managed KMS key.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-KNS-003.md
[Ensure Kubernetes secrets are encrypted using CMKs managed in AWS KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-004.md
[Ensure Lambda IAM policy is not overly permissive to all traffic]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-011.md
[Ensure LoadBalancer TargetGroup Protocol values are limited to HTTPS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-019.md
[Ensure LoadBalancer scheme is set to internal and not internet-facing]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-017.md
[Ensure MSK cluster is setup in GS VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-004.md
[Ensure Neptune logging is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NPT-001.md
[Ensure PGAudit is enabled on RDS Postgres instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-014.md
[Ensure QLDB ledger permissions mode is set to STANDARD]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-QLDB-001.md
[Ensure RDS DB instance has setup backup retention period of at least 30 days.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-030.md
[Ensure RDS cluster do not use a deprecated version of Aurora-PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-022.md
[Ensure RDS cluster has IAM authentication enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-016.md
[Ensure RDS clusters and instances have deletion protection enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-013.md
[Ensure RDS dbcluster do not use a deprecated version of PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-024.md
[Ensure RDS instace has IAM authentication enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-017.md
[Ensure RDS instances do not use a deprecated version of Aurora-PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-021.md
[Ensure RDS instances do not use a deprecated version of PostgreSQL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-023.md
[Ensure RabbitMQ engine version is approved by GS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MQ-004.md
[Ensure Redshift cluster allow version upgrade by default]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-005.md
[Ensure Redshift cluster is not provisioned using EC2-classic (deprecated) platform.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-009.md
[Ensure Redshift database clusters are not using default master username.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-011.md
[Ensure Redshift database clusters are not using default port(5439) for database connection.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-012.md
[Ensure Redshift is not deployed outside of a VPC]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-006.md
[Ensure Route53 DNS evaluateTargetHealth is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-R53-001.md
[Ensure S3 Bucket BlockPublicPolicy is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-021.md
[Ensure S3 Bucket has public access blocks]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-018.md
[Ensure S3 bucket ACL is in use and any user other than the owner does not have any access on it.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-026.md
[Ensure S3 bucket IgnorePublicAcls is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-020.md
[Ensure S3 bucket RestrictPublicBucket is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-019.md
[Ensure S3 bucket cross-region replication is enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-017.md
[Ensure S3 bucket has enabled lock configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-016.md
[Ensure S3 bucket is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-015.md
[Ensure S3 hosted sites supported hardened CORS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-014.md
[Ensure SNS Topic policy is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-004.md
[Ensure SNS is only accessible via specific VPCe service.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-009.md
[Ensure SNS topic is configured with secure data transport policy.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SNS-010.md
[Ensure SQS data is encrypted in Transit using SSL/TLS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-008.md
[Ensure SQS is only accessible via specific VPCe service.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-007.md
[Ensure SQS policy documents do not allow all actions]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-005.md
[Ensure SQS queue policy is not publicly accessible]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SQS-004.md
[Ensure Security groups has attached to a VPCs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-033.md
[Ensure Slow Logs feature is enabled for ElasticSearch cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-011.md
[Ensure Termination protection is enabled for instances in the cluster for EMR.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EMR-010.md
[Ensure Timestream database is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-TS-001.md
[Ensure Transfer Server is not publicly exposed]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-TRF-001.md
[Ensure Transfer Server is not use FTP protocol.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-TRF-002.md
[Ensure VPC endpoint service is configured for manual acceptance]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-003.md
[Ensure VPC peering connection is not active.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-005.md
[Ensure all EIP addresses allocated to a VPC are attached related EC2 instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-002.md
[Ensure all load balancers created are application load balancers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-018.md
[Ensure an IAM policy is defined with the stack.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFR-004.md
[Ensure authentication to Kibana is SAML based in ElasticSearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-012.md
[Ensure auto scaling groups associated with a load balancer use elastic load balancing health checks]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AS-002.md
[Ensure automated backups are enabled for Redshift cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-013.md
[Ensure capabilities in stacks do not have * in it.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFR-005.md
[Ensure client authentication is enabled with TLS (mutual TLS authentication)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-003.md
[Ensure container insights are enabled on ECS cluster]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-008.md
[Ensure content encoding is enabled for API Gateway.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-010.md
[Ensure custom domain in AWS API Gateway has GS-managed ACM certificate associated.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-011.md
[Ensure custom endpoint has GS-managed ACM certificate associated in ElasticSearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-014.md
[Ensure data is Encrypted in transit (TLS)]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-002.md
[Ensure default VPC is not being used.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-VPC-004.md
[Ensure deferred maintenance window is enabled for Redshift cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RSH-010.md
[Ensure detailed monitoring is enabled for EC2 instances]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-005.md
[Ensure enhanaced monitoring for AWS MSK is not set to default.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-006.md
[Ensure every Security Group rule contains a description]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-023.md
[Ensure fine-grained access control is enabled during domain creation in ElasticSearch.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-013.md
[Ensure for AWS DAX GS-managed key is used in encryption.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DAX-003.md
[Ensure in AWS ElastiCache, automatic backups is enabled for Redis cluster.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-007.md
[Ensure lifecycle policy is enabled for ECR image repositories.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECR-007.md
[Ensure no IAM policy has a resource specified in the following format:'arn:aws:*:*']: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-004.md
[Ensure no wildcards are specified in IAM policy with 'Action' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-002.md
[Ensure no wildcards are specified in IAM policy with 'Resource' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-001.md
[Ensure no wildcards are specified in IAM trust-relationship policy with 'Principal' section]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-003.md
[Ensure node-to-node encryption is enabled on each ElasticSearch Domain]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ES-007.md
[Ensure one of Subnets or SubnetMappings is defined for loadbalancer]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-016.md
[Ensure only private access for Amazon EKS cluster's Kubernetes API is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EKS-008.md
[Ensure public access is disabled for AWS MSK.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-007.md
[Ensure respective logs of Amazon RDS instance are enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-RDS-018.md
[Ensure termination protection in stacks is enabled.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CFR-006.md
[Ensure that API Gateway has enabled access logging]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-AG-004.md
[Ensure that AWS Elastic Load Balancer v2 (ELBv2) has deletion protection feature enabled]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-020.md
[Ensure that AWS ensure Gateway Load Balancer (GWLB) is not being used]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-021.md
[Ensure that Application Load Balancer drops HTTP headers]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-013.md
[Ensure that CodeBuild projects are encrypted using CMK]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-CB-002.md
[Ensure that EC2 instace is EBS Optimized]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC2-004.md
[Ensure that ECS Service and Task Set network configuration disallows the assignment of public IPs]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-010.md
[Ensure that ECS Task Definition have their network mode property set to awsvpc]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-014.md
[Ensure that ECS services and Task Sets are launched as Fargate type]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-011.md
[Ensure that ElastiCache replication Group (Redis) are encrypted at rest with customer managed CMK key]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-EC-005.md
[Ensure that Secrets Manager secret is encrypted using KMS]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SM-001.md
[Ensure that Workspace root volumes is encrypted.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-WS-002.md
[Ensure that Workspace user volumes is encrypted]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-WS-001.md
[Ensure that a log driver has been configured for each ECS task definition.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-017.md
[Ensure that public facing ELB has WAF attached]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-024.md
[Ensure that the AWS EC2 instances don't have a risky set of permissions management access to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-013.md
[Ensure that the AWS EC2 instances provisioned in your AWS account don't have a risky set of write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-016.md
[Ensure that the AWS ECR Repository resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-022.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of org write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-017.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of permissions management access permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-015.md
[Ensure that the AWS Lambda Function instances provisioned in your AWS account don't have a risky set of write permissions to minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-014.md
[Ensure that the AWS Lambda Function resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-023.md
[Ensure that the AWS S3 bucket resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-024.md
[Ensure that the AWS SQS Queue resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-025.md
[Ensure that the AWS Secret Manager Secret resources provisioned in your AWS account are not publicly accessible from the Internet to avoid sensitive data exposure and minimize security risks.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-026.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of ec2.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-019.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of ecs task definition.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-021.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of elastic bean stalk.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-018.md
[Ensure that the AWS policies don't have '*' in the resource section of the policy statement of lambda function.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-IAM-020.md
[Ensure that the CertificateManager certificates reference only Private ACMPCA certificate authorities]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ACM-003.md
[Ensure the ELBv2 ListenerCertificate ListenerArn value is defined]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-014.md
[Ensure the Load Balancer Listener SSLPolicy is set to at least one value from approved policies]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ELB-015.md
[Ensure there are no rules in the Default VPC NACL.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-008.md
[Ensure there are no undefined ECS task definition empty roles for ECS.]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-016.md
[Ensure to enable EnforceWorkGroupConfiguration for athena workgroup]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ATH-001.md
[Instance is communicating with ports known to mine Bitcoin]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-031.md
[Instance is communicating with ports known to mine Ethereum]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-032.md
[JMSAppender in Log4j 1.2 is vulnerable to deserialization of untrusted data when the attacker has write access to the Log4j configuration]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-WAF-001.md
[Publicly exposed DB Ports]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-SG-030.md
[S3 buckets with configurations set to host websites]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-S3-013.md
[Unrestricted Inbound Traffic on Remote Server Administration Ports]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-NACL-007.md
[Use KMS Customer Master Keys for AWS MSK Clusters]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-MSK-001.md
[VPC configurations on ECS Services and TaskSets must use either vended security groups]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-013.md
[Value(s) of subnets attached to aws ecs service or taskset AwsVpcConfiguration resources are vended]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-ECS-012.md
[dynamodb kinesis specification property should not be null]: https://github.com/prancer-io/prancer-compliance-test/tree/master/docs/policies/aws/Cloud/all/PR-AWS-CLD-DD-003.md
