...
# Master Test ID: PR-AZR-TRF-SQL-062
...
***<font color="white">Title:</font>*** PostgreSQL Database Server should not allow ingress from all Azure-internal IP addresses (0.0.0.0/0)

***<font color="white">Description:</font>*** This policy will identify PostgreSQL Database Server firewall rule that are currently allowing ingress from all Azure-internal IP addresses  
