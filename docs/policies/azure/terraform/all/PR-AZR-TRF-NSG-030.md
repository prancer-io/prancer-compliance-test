...
# Master Test ID: PR-AZR-TRF-NSG-030
...
***<font color="white">Title:</font>*** Azure Network Security Group with Outbound rule to allow all traffic to any source
