...
# Master Test ID: PR-AZR-TRF-NSG-003
...
***<font color="white">Title:</font>*** Azure Network Security Group (NSG) having Inbound rule overly permissive to all traffic from Internet on TCP protocol
