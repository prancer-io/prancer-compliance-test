...
***<font color="white">Title:</font>*** Azure App Service PHP version should be latest

***<font color="white">Description:</font>*** This policy will identify the Azure app service which dont have latest version of PHP and give alert  
