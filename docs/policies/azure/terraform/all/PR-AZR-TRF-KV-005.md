...
# Master Test ID: PR-AZR-TRF-KV-005
...
***<font color="white">Title:</font>*** Azure Key Vault secrets should have an expiration date
...
***<font color="white">Resource Types:</font>*** ['azurerm_key_vault_secret']
