...
***<font color="white">Title:</font>*** Ensure SQL server's TDE protector is encrypted with Customer-managed key
...
***<font color="white">Resource Types:</font>*** ['azurerm_mssql_server', 'azurerm_mssql_server_transparent_data_encryption']
