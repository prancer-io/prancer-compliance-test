...
# Master Test ID: PR-AZR-TRF-SQL-027
...
|Title|Description|
| :---: | :---: |
|id|PR-AZR-TRF-SQL-027|
|eval|data.rule.sql_db_ads_scan|
|message|data.rule.sql_db_ads_scan_err|
...
|remediationFunction|PR_AZR_TRF_SQL_027.py|


***<font color="white">Severity:</font>*** Low

***<font color="white">Title:</font>*** Azure SQL Server advanced data security recurring scans should be enabled
