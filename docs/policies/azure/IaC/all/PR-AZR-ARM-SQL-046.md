...
***<font color="white">Resource Types:</font>*** ['microsoft.sql/servers/encryptionprotector']


[sql_servers_encryption.rego]: https://github.com/prancer-io/prancer-compliance-test/tree/master/azure/iac/sql_servers_encryption.rego
