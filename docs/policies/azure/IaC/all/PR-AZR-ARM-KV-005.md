...
***<font color="white">Description:</font>*** This policy identifies Azure Key Vault secrets that do not have an expiratiSon date. As a best practice, set an expiration date for each secret and rotate the secret regularly.  
...
***<font color="white">Resource Types:</font>*** ['microsoft.keyvault/vaults/secrets']


[keyvaultsecrets.rego]: https://github.com/prancer-io/prancer-compliance-test/tree/master/azure/iac/keyvaultsecrets.rego
