...
***<font color="white">Description:</font>*** Application Gateway allows setting network protocols Http and Https. It is highly recommended to use Https protocol for secure connections.  
