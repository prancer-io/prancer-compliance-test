...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0053",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the --address argument is set to 127.0.0.1 (Controller Manager) ",
    "Policy Description": "Ensure that the --address argument is set to 127.0.0.1 (Controller Manager) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
