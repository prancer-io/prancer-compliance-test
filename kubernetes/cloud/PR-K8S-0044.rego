...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0044",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the --repair-malformed-updates argument is set to false (API Server) ",
    "Policy Description": "Ensure that the --repair-malformed-updates argument is set to false (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
