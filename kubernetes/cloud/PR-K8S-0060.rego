...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0060",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the --audit-log-maxage argument is set to 30 or as appropriate (API Server) ",
    "Policy Description": "Ensure that the --audit-log-maxage argument is set to 30 or as appropriate (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
