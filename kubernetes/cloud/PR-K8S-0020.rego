...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0020",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the --basic-auth-file argument is not set (API Server) ",
    "Policy Description": "Ensure that the --basic-auth-file argument is not set (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
