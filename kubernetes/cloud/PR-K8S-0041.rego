...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0041",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the admission control plugin EventRateLimit is set (API Server) ",
    "Policy Description": "Ensure that the admission control plugin EventRateLimit is set (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
