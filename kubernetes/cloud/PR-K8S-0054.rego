...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0054",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the admission control plugin DenyEscalatingExec is set (API Server) ",
    "Policy Description": "Ensure that the admission control plugin DenyEscalatingExec is set (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
