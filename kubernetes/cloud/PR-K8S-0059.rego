...
k8s_issue_metadata := {
    "Policy Code": "PR-K8S-0059",
    "Type": "Cloud",
    "Product": "Kubernetes",
    "Language": "Cloud",
    "Policy Title": "Ensure that the --audit-log-path argument is set as appropriate (API Server) ",
    "Policy Description": "Ensure that the --audit-log-path argument is set as appropriate (API Server) ",
    "Resource Type": "pod",
    "Policy Help URL": "",
    "Resource Help URL": ""
}
