...
# Check if azurerm_virtual_network_peering resources exist
azurerm_virtual_network_peering_exists {
    existence.azure_resource_exists("azurerm_virtual_network_peering")
}
