...
# Check if azurerm_mssql_server_extended_auditing_policy resources exist
azurerm_mssql_server_extended_auditing_policy_exists {
    existence.azure_resource_exists("azurerm_mssql_server_extended_auditing_policy")
}
