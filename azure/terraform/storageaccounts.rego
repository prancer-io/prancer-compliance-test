...
storage_secure_metadata := {
    ...
    "Product": "AZR",
    "Language": "Terraform",
    "Policy Title": "Storage Accounts Secure transfer should be enabled",
...
# Required property and defaults to false
#azure_attribute_absence["storage_secure"] {
#    resource := input.resources[_]
#    lower(resource.type) == "azurerm_storage_account"
...
storage_account_public_access_disabled_err = "Storage Account currently allowing public access to all blobs or containers, which need to be disabled" {
    azure_issue["storage_secure"]
}
...
storage_account_public_access_disabled_metadata := {
    ...
    "Product": "AZR",
    "Language": "Terraform",
    "Policy Title": "Storage Account should not allow public access to all blobs or containers",
