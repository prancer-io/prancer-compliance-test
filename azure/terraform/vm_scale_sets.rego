...
# Check if azurerm_virtual_machine_scale_set resources exist
azurerm_virtual_machine_scale_set_exists {
    existence.azure_resource_exists("azurerm_virtual_machine_scale_set")
}
