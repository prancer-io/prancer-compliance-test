...
event_grid_topic_has_public_network_access_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-001",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_topic_has_local_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-002",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_domain_configured_with_private_endpoint_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-003",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_topic_configured_with_private_endpoint_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-004",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_domain_has_public_network_access_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-005",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_domain_has_local_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-006",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
event_grid_partnernamespace_has_local_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-CLD-EGR-009",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
