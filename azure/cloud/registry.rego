...
aci_configured_with_vnet_metadata := {
    ...
    "Policy Help URL": "",
    "Resource Help URL": "https://learn.microsoft.com/en-us/azure/templates/microsoft.containerinstance/containergroups?tabs=json&pivots=deployment-language-CLD-template"
}
...
acr_public_access_disabled_metadata := {
    ...
    "Resource Type": "Microsoft.ContainerRegistry/registries",
    "Policy Help URL": "",
    "Resource Help URL": "https://learn.microsoft.com/en-us/azure/templates/microsoft.containerregistry/registries?pivots=deployment-language-CLD-template"
}