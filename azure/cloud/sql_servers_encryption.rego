...
# Check if microsoft.sql/servers/encryptionprotector resources exist
microsoft_sql_servers_encryptionprotector_exists {
    existence.azure_resource_exists("microsoft.sql/servers/encryptionprotector")
}
...
serverKeyType_metadata := {
    "Policy Code": "PR-AZR-CLD-SQL-046",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
