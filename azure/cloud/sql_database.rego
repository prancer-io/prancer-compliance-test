...
# Check if microsoft.sql/servers/databases/backupshorttermretentionpolicies resources exist
microsoft_sql_servers_databases_backupshorttermretentionpolicies_exists {
    existence.azure_resource_exists("microsoft.sql/servers/databases/backupshorttermretentionpolicies")
}
...
sql_db_backup_usage_locally_redundant_backup_storage_metadata := {
    "Policy Code": "PR-AZR-CLD-SQL-078",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
...
sql_db_backup_restore_retention_config_metadata := {
    "Policy Code": "PR-AZR-CLD-SQL-079",
    "Type": "Cloud",
    "Product": "AZR",
    "Language": "",
