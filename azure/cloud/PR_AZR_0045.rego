...
# If NSG dose not allows VNC Server TCP Port 5900
...
get_source_port[security_rule] {
    get_access[security_rule]
    security_rule.properties.sourcePortRange = "5900"
}

# Method for check rule
get_destination_port[security_rule] {
    get_access[security_rule]
    security_rule.properties.destinationPortRange = "5900"
}
# Method for check rule
get_source_PortRanges[security_rule] {
    get_access[security_rule]
    security_rule.properties.sourcePortRanges[_] = "5900"
}
# Method for check rule
get_destination_PortRanges[security_rule] {
    get_access[security_rule]
    security_rule.properties.destinationPortRanges[_] = "5900"
}
# Method for check rule
...
# @.sourcePortRange == '5900')].destinationPortRange contains _Port.inRange(5900)
public_security_rules_any["internet_on_PortRange_5900_any_source"] {
    some security_rule
    get_source_port[security_rule]
...
# @.sourcePortRanges[*] == '5900')].destinationPortRanges[*] contains _Port.inRange(5900)
public_security_rules_any["internet_on_PortRanges_5900_any_source"] {
    some security_rule
    get_source_PortRanges[security_rule]
    security_rule.properties.sourceAddressPrefix = "*"
    security_rule.properties.protocol = "TCP"
...
# or "securityRules[?(@.access == 'Allow' && @.direction == 'Inbound' && @.sourceAddressPrefix == '*' && @.protocol = 'TCP'
# @.sourcePortRanges[*] == '*')].destinationPortRanges[*] contains _Port.inRange(5900)
...
# @.sourcePortRange == '5900')]‌.destinationPortRange contains _Port.inRange(5900)
public_security_rules_Internet["internet_on_PortRange_5900_Internet_source"] {
    some security_rule
    get_source_port[security_rule]
...
# or "securityRules[?(@.access == 'Allow' && @.direction == 'Inbound' && @.sourceAddressPrefix == 'Internet' && @.protocol = 'TCP'
#  @.sourcePortRanges[*] == '5900')].destinationPortRanges[*] contains _Port.inRange(5900)
public_security_rules_Internet["internet_on_PortRanges_5900_Internet_source"] {
    some security_rule
    get_source_PortRanges[security_rule]
    security_rule.properties.sourceAddressPrefix = "Internet"
    security_rule.properties.protocol = "TCP"
