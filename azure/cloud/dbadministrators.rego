...
# Check if microsoft.sql/managedinstances/administrators resources exist
microsoft_sql_managedinstances_administrators_exists {
    existence.azure_resource_exists("microsoft.sql/managedinstances/administrators")
}
