...
# Check if microsoft.sql/servers/databases/auditingsettings resources exist
microsoft_sql_servers_databases_auditingsettings_exists {
    existence.azure_resource_exists("microsoft.sql/servers/databases/auditingsettings")
}
