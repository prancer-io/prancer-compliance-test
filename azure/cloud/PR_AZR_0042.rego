...
# If NSG dose not allows SQLServer TCP Port 1433
...
get_source_port[security_rule] {
    get_access[security_rule]
    security_rule.properties.sourcePortRange = "1433"
}

# Method for check rule
get_destination_port[security_rule] {
    get_access[security_rule]
    security_rule.properties.destinationPortRange = "1433"
}
# Method for check rule
get_source_PortRanges[security_rule] {
    get_access[security_rule]
    security_rule.properties.sourcePortRanges[_] = "1433"
}
# Method for check rule
get_destination_PortRanges[security_rule] {
    get_access[security_rule]
    security_rule.properties.destinationPortRanges[_] = "1433"
}
# Method for check rule
...
# @.sourcePortRange == '1433')].destinationPortRange contains _Port.inRange(1433)
public_security_rules_any["internet_on_PortRange_1433_any_source"] {
    some security_rule
    get_source_port[security_rule]
...
# @.sourcePortRanges[*] == '1433')].destinationPortRanges[*] contains _Port.inRange(1433)
public_security_rules_any["internet_on_PortRanges_1433_any_source"] {
    some security_rule
    get_source_PortRanges[security_rule]
    security_rule.properties.sourceAddressPrefix = "*"
    security_rule.properties.protocol = "TCP"
...
# or "securityRules[?(@.access == 'Allow' && @.direction == 'Inbound' && @.sourceAddressPrefix == '*' && @.protocol = 'TCP'
# @.sourcePortRanges[*] == '*')].destinationPortRanges[*] contains _Port.inRange(1433)
...
# @.sourcePortRange == '1433')]‌.destinationPortRange contains _Port.inRange(1433)
public_security_rules_Internet["internet_on_PortRange_1433_Internet_source"] {
    some security_rule
    get_source_port[security_rule]
...
# or "securityRules[?(@.access == 'Allow' && @.direction == 'Inbound' && @.sourceAddressPrefix == 'Internet' && @.protocol = 'TCP'
#  @.sourcePortRanges[*] == '1433')].destinationPortRanges[*] contains _Port.inRange(1433)
public_security_rules_Internet["internet_on_PortRanges_1433_Internet_source"] {
    some security_rule
    get_source_PortRanges[security_rule]
    security_rule.properties.sourceAddressPrefix = "Internet"
    security_rule.properties.protocol = "TCP"
