...
# Check if microsoft.network/virtualnetworks/virtualnetworkpeerings resources exist
microsoft_network_virtualnetworks_virtualnetworkpeerings_exists {
    existence.azure_resource_exists("microsoft.network/virtualnetworks/virtualnetworkpeerings")
}
