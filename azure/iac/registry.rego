...
acr_repository_scoped_access_token_disabled_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-007",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_has_premium_sku_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-008",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_anonymous_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-009",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_not_allowing_unrestricted_network_access_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-010",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_has_arm_audience_token_auth_disabled_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-012",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_export_disabled_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-013",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
acr_usage_custom_managed_key_for_encryption_metadata := {
    "Policy Code": "PR-AZR-ARM-ACR-014",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
