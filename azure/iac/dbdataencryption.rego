...
# Check if microsoft.sql/servers/databases/transparentdataencryption resources exist
microsoft_sql_servers_databases_transparentdataencryption_exists {
    existence.azure_resource_exists("microsoft.sql/servers/databases/transparentdataencryption")
}
