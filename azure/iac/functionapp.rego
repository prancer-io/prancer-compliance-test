...
https_only_metadata := {
    "Policy Code": "PR-AZR-ARM-AFA-001",
    "Type": "IaC",
    "Product": "AZR",
...
min_tls_version_metadata := {
    "Policy Code": "PR-AZR-ARM-AFA-002",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
client_cert_enabled_metadata := {
    "Policy Code": "PR-AZR-ARM-AFA-003",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
http_20_enabled_metadata := {
    "Policy Code": "PR-AZR-ARM-AFA-004",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
...
functionapp_managed_identity_provider_enabled_metadata := {
    "Policy Code": "PR-AZR-ARM-AFA-006",
    "Type": "IaC",
    "Product": "AZR",
    "Language": "ARM template",
