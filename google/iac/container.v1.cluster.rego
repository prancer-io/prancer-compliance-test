...
k8s_logging_err = "Kubernetes Engine Cluster attribute loggingService config missing in the resource" {
    gc_attribute_absence["k8s_logging"]
}
...
k8s_monitor_err = "Kubernetes Engine Cluster attribute monitoringService config missing in the resource" {
    gc_attribute_absence["k8s_monitor"]
}
...
k8s_node_image_err = "Kubernetes Engine Cluster attribute imageType config missing in the resource" {
    gc_attribute_absence["k8s_node_image"]
}
...
k8s_db_encrypt_err = "Kubernetes Engine Cluster attribute databaseEncryption config missing in the resource" {
    gc_attribute_absence["k8s_db_encrypt"]
}
...
k8s_auto_upgrade_err = "Kubernetes Engine Cluster attribute currentNodeCount config missing in the resource" {
    gc_attribute_absence["k8s_auto_upgrade"]
}
