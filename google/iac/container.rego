...
k8s_zones_err = "GCP Kubernetes cluster Application-layer Secrets decrypted" {
    gc_issue["k8s_zones"]
}

k8s_zones_miss_err = "Kubernetes cluster not in redundant zones for Google Cloud Provider" {
...
gc_issue["k8s_channel"] {
    resource := input.resources[i]
    lower(resource.type) == "container.v1.cluster"
    not resource.properties.releaseChannel.channel
}
...
k8s_workload_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-028",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
gc_issue["k8s_shield_node"] {
    resource := input.resources[i]
    lower(resource.type) == "container.v1.cluster"
    lower(resource.properties.shieldedNodes) == "false"
}

gc_issue["k8s_shield_node"] {
    resource := input.resources[i]
    lower(resource.type) == "container.v1.cluster"
    not resource.properties.shieldedNodes
}
...
k8s_shield_node_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-029",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
k8s_node_autorepair_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-030",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
k8s_node_autoupgrade_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-031",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
k8s_secure_boot_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-032",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
k8s_integrity_monitor_metadata := {
    "Policy Code": "PR-GCP-GDF-CLT-033",
    "Type": "IaC",
    "Product": "GCP",
    "Language": "GCP deployment",
...
k8s_cld_monitoring_metadata := {
    "Policy Code": "PR-GCP-CLD-CLT-036",
    "Type": "IAC",
    "Product": "GCP",
    "Language": "GCP Deployment",
