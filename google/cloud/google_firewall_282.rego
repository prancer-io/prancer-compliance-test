...
# Firewall rule allows internet traffic to NetBIOS-SSN port (139)
# If firewall rule not allows internet traffic to NetBIOS-SSN port (139)
...
# (sourceRanges[*] contains 0.0.0.0/0 and allowed[*].ports[139] )
allowport["ALLOW_PORT"] {
    get_access[security_rule]
    input.sourceRanges[_]="0.0.0.0/0"
    input.allowed[_].ports[_]="139"
}
