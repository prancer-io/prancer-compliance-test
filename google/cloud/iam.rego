...
gcp_dont_have_non_corporate_account_metadata := {
    ...
    "Product": "GCP",
    "Language": "GCP deployment",
    "Policy Title": "Ensure, Non-corporate accounts dont have access to Google Cloud Platform (GCP) resources",
...
seperation_of_duties_been_enforced_on_user_accounts_metadata := {
    ...
    "Product": "GCP",
    "Language": "GCP cloud",
    "Policy Title": "Separation of duties should be enforced on user accounts containg service account related roles",
...
seperation_of_duties_been_enforced_on_user_accounts_for_kms_privileges_metadata := {
    ...
    "Product": "GCP",
    "Language": "GCP cloud",
    "Policy Title": "Separation of duties should be enforced on user accounts containg KMS related roles",
